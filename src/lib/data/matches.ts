...
export const MATCHES_2026: Match2026[] = [
  ...
  { num: 77, stage: 'r32', date: '2026-06-30', time: '18:00', location: 'Nova York/NJ (EUA)',                       home: pos('I', 1), away: third('C/D/F/G/H') },
  { num: 78, stage: 'r32', date: '2026-06-30', time: '14:00', location: 'Dallas/Arlington (EUA)',                   home: pos('E', 2), away: pos('I', 2) },
  { num: 79, stage: 'r32', date: '2026-06-30', time: '22:00', location: 'Estádio Azteca, Cidade do México (MEX)',   home: pos('A', 1), away: third('C/E/F/H/I') },
  ...
  { num: 94, stage: 'r16', date: '2026-07-06', time: '21:00', location: 'Seattle (EUA)',                            home: w(81), away: w(82) },
